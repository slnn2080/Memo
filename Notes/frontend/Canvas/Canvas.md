...
### **<font color='#C2185B'>ctx.clearRect(x, y, width, height)</font>**
...
所以当我们调用 ctx.restore() 方法 弹出栈的时候 第一次调用的是栈顶的样式(也就是最新压入栈的结构)
```s
...
### **<font color='#C2185B'>ctx.fill()</font>**
...
### **<font color='#C2185B'>ctx.fillRect(x, y, w, h)</font>**
绘制一个有填充色的矩形
